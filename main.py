...
NOTA: Quando está ativado o ambiente virtual do 'poetry', você observará
      algo parecido com o seguinte:

      $ (projeto_de_machine_learning_usando_hydra_e-1vXEXwDs-py3.10) eddygiusepe@eddygiusepe:~/Documentos/ML_Project_with_Hydra_and_poetry$ 
"""
import hydra
